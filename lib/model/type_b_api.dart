...
class TypeBApi {
  ...
  TypeBApi({this.message});

  TypeBApi.fromJson(Map<String, dynamic> json) {
...
class PrimaryGenres {
  ...
  PrimaryGenres.fromJson(Map<String, dynamic> json) {
    if(json["music_genre_list"] is List)
      this.musicGenreList = json["music_genre_list"]==null ? null : (json["music_genre_list"] as List).map((e)=>MusicGenreList.fromJson(e)).toList();
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if(this.musicGenreList != null)
      data["music_genre_list"] = this.musicGenreList!.map((e)=>e.toJson()).toList();
    return data;
  }
}
...
class MusicGenreList {
  ...
  MusicGenreList.fromJson(Map<String, dynamic> json) {
    if(json["music_genre"] is Map)
      this.musicGenre = json["music_genre"] == null ? null : MusicGenre.fromJson(json["music_genre"]);
  }
...
class MusicGenre {
  ...
  MusicGenre.fromJson(Map<String, dynamic> json) {
    if(json["music_genre_id"] is int)
      this.musicGenreId = json["music_genre_id"];
    if(json["music_genre_parent_id"] is int)
      this.musicGenreParentId = json["music_genre_parent_id"];
    if(json["music_genre_name"] is String)
      this.musicGenreName = json["music_genre_name"];
    if(json["music_genre_name_extended"] is String)
      this.musicGenreNameExtended = json["music_genre_name_extended"];
    if(json["music_genre_vanity"] is String)
      this.musicGenreVanity = json["music_genre_vanity"];
  }
